...
const ProjectCard = ({imgUrl, title, description, liveProjectUrl, sourceUrl }:
                         {imgUrl:string, title:string, description:string, liveProjectUrl:string, sourceUrl:string}) => {
    return (
        <div>
            <div
            ...
            >
                <div className="overlay absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500 items-center justify-center">
                    <Link
                        href={liveProjectUrl? liveProjectUrl : "#"}
